...
public class VertexTest {
    ...
    public void testGetKey() {
        ...
        Vertex instance1 = new Vertex(1, l);
        expResult = 1;
    ...
    public void testSetElement() {
        ...
        instance.setElement(l);
        assertEquals(l, instance.getElement());
    }
    ...
    public void testGetAdjVert() {
        ...
        instance.addAdjVert(l, edge);
        assertEquals(l, instance.getAdjVert(edge));
    }
    ...
    public void testRemAdjVert() {
        ...
        instance.addAdjVert(l, edge1);

        Edge edge2 = new Edge();
        instance.addAdjVert(l2, edge2);

        instance.remAdjVert(l);
        assertTrue("result should be one", (instance.numAdjVerts() == 1));

        instance.remAdjVert(l2);
        assertTrue("result should be zero", (instance.numAdjVerts() == 0));
    }
    ...
    public void testGetEdge() {
        ...
        assertEquals(edge1, instance.getEdge(l));

        Edge edge2 = new Edge();
        instance.addAdjVert(l2, edge2);

        assertEquals(edge2, instance.getEdge(l2));
    }
    ...
    public void testGetAllAdjVerts() {
        ...
        assertTrue("first adjacency vertice should be VAdj1", (itVerts.next().equals(l)));
        assertTrue("second adjacencyvertice should be VAdj2", (itVerts.next().equals(l2)));

        instance.remAdjVert(l);

        itVerts = instance.getAllAdjVerts().iterator();
        assertTrue("first adjacency vertice should be VAdj2", (itVerts.next().equals(l2)));
    ...
    public void testGetAllOutEdges() {
        ...
        Iterator<Edge> itEdges = instance.getAllOutEdges().iterator();
    ...
    public void testEquals() {
        ...
        Vertex instance2 = new Vertex(2, l2);

        Edge edge1 = new Edge(null, 2, instance, instance2);
        instance.addAdjVert(l2, edge1);
        ...
        Vertex other = instance.clone();
        other.remAdjVert(l2);
        assertFalse("instance should not be equal to other", instance.equals(other));

        other.addAdjVert(l2, edge1);
        assertTrue("instance should be equal to other", instance.equals(other));

        Vertex instance3 = new Vertex(3, l3);
        Edge edge2 = new Edge(null, 3, instance, instance3);
        instance.addAdjVert(l3, edge2);
        assertFalse("instance should not be equal to other", instance.equals(other));
    }
    ...
    public void testClone() {
        ...
        Vertex instClone = instance.clone();
        ...
        //and edges also
        Iterator<Edge> itedgeSource = instance.getAllOutEdges().iterator();
        while (itedgeSource.hasNext()) {
            Iterator<Edge> itedgeClone = instClone.getAllOutEdges().iterator();
